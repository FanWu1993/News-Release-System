...
window.location="/news/servlet/DelType?ID="+date;
...
<%
   ...
   %>
    <tr bgcolor="#FFFFFF">
      ...
      <td><%=typeName%></td>
      <td><%=dateTime%></td>
      <td><div align="center"><a href="typeUpdate.jsp?ID=<%=id%>&type=<%=typeName%>">修改</a>&nbsp;&nbsp;&nbsp;<a href="javascript:projectDelete('<%=id%>')">删除</a></div></td>
    </tr>
<%}
 con.close();
%>
  ...
  <p><a href="insertType.jsp"><font style="font-size:9pt">添加类别名称</font></a></p>
	</td>
  </tr>
    </table>
 </body>
